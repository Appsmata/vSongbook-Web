...
return array(
	...
	'caching_dir_error' => 'The directory ^ defined as AS_CACHE_DIRECTORY is not writable by the web server.',
	'caching_dir_missing' => 'Cache directory has not been defined.',
	'caching_dir_public' => 'The directory ^ defined as AS_CACHE_DIRECTORY must be outside the public root.',
	...
	'categories_not_shown' => 'Some songs have categories which will not be displayed.',
	...
	'category_no_sub_error' => '^q song/s in this category have no sub-category - ^1set sub-category^2',
	'category_no_sub_to' => 'Move songs in ^ with no sub-category to:',
	'category_no_subs' => 'None',
	'category_none_error' => '^q song/s currently have no category - ^1set category^2',
	'category_none_to' => 'Move songs with no category to:',
	...
	'delete_category_reassign' => 'Delete this category and reassign its songs to:',
	...
	'delete_hidden_note' => ' - all hidden songs, review and comments without dependents',
	...
	'hidden_reviews_deleted' => 'Deleted ^1 of ^2 hidden reviews without dependents...',
	'hidden_comments_deleted' => 'Deleted ^1 of ^2 hidden comments...',
	'hidden_songs_deleted' => 'Deleted ^1 of ^2 hidden songs without dependents...',
	'hidden_title' => 'Hidden',
	'hotness_factors' => 'Relative importance for song hotness:',
	'ip_address_pages' => 'IP address pages',
	'layout_title' => 'Layout',
	'link_name' => 'Text of link:',
	'link_new_window' => 'Open link in a new window',
	'link_url' => 'URL of link - absolute or relative to APS root:',
	'lists_title' => 'Lists',
	...
	'pages_explanation' => 'Click the \'Add Page\' button to add custom content to your APS site, or \'Add Link\' to link to any other web page.',
	'pages_title' => 'Pages',
	...
	'aps_build_date' => 'Build date:',
	'aps_db_size' => 'Database size:',
	'aps_db_version' => 'APS database version:',
	'aps_latest_version' => 'Latest version:',
	'aps_version' => 'vSongBook version:',
	'song_lists' => 'Song lists',
	'song_pages' => 'Song pages',
	...
	'recalc_categories_recounting' => 'Recounting songs for ^1 of ^2 categories...',
	...
	'recalc_posts_count' => 'Getting total number of songs, reviews and comments...',
	...
	'recount_posts_as_recounted' => 'Recounted reviews and hotness for ^1 of ^2 posts...',
	'recount_posts_complete' => 'All posts were successfully recounted.',
	'recount_posts_note' => ' - the number of reviews, thumbs, flags and hotness for each post',
	'recount_posts_stop' => 'Stop recounting',
	'recount_posts_thumbs_recounted' => 'Recounted thumbs and flags for ^1 of ^2 posts...',
	...
	'refill_events_refilled' => 'Refilled for ^1 of ^2 songs...',
	'registration_fields' => 'add registration fields',
	'reindex_content' => 'Reindex content',
	'reindex_content_note' => ' - for searching and related song suggestions',
	...
	'requires_aps_version' => 'Disabled - requires vSongBook ^ or later',
	...
	'show_on_signup_form' => 'Show field on user registration form',
	...
	'tags_not_shown' => 'Some songs have tags which will not be displayed.',
	...
	'total_as' => 'Total reviews:',
	'total_cs' => 'Total comments:',
	'total_bs' => 'Total songbooks:',
	'total_qs' => 'Total songs:',
	'total_qs_unans' => 'Total songs unreviewed:',
	'unnamed_plugin' => 'Unnamed Plugin',
	'upgrade_db' => 'Your vSongBook database needs to be ^1upgraded^2 for this version.',
	...
	'users_signuped' => 'Registered users:',
	'users_title' => 'Users',
	'users_thumbd' => 'Users who thumbd:',
	'version_get_x' => 'get ^',
	'version_latest' => 'latest',
	'version_latest_unknown' => 'latest unknown',
	'version_requires_php' => '^1 requires PHP ^2',
	'version_requires_aps' => '^1 requires APS ^2',
