 ...
 * @return mixed
 */
function as_song_create($followreview, $userid, $handle, $cookieid, $number, $songkey, $title, $content, $format, $text, $tagstring, $notify, $email,
	$categoryid = null, $extravalue = null, $queued = false, $name = null)
{
	...
	$postid = as_db_post_create($queued ? 'S_QUEUED' : 'S', @$followreview['postid'], $userid, isset($userid) ? null : $cookieid,
		as_remote_ip_address(), $number, $songkey, $title, $content, $format, $tagstring, as_combine_notify_email($userid, $notify, $email),
