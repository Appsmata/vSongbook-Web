 ...
 * @param bool $silent
 */
function as_song_set_content($oldsong, $title, $content, $format, $text, $tagstring, $notify, $userid, $handle, $cookieid, $extravalue = null, $name = null, $remoderate = false, $silent = false)
{
	...
	as_db_post_set_content($oldsong['postid'], $title, $content, $format, $tagstring, $notify,
