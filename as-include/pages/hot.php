...
/*
	...
	Description: Controller for page listing hot songs
...
// Get list of hottest songs, allow per-category if AS_ALLOW_UNINDEXED_QUERIES set in as-config.php
...
return as_s_list_page_content(
	$songs, // songs
	as_opt('page_size_hot_qs'), // songs per page
	$start, // start offset
	...
	as_html_suggest_post() // suggest what to do next
);
