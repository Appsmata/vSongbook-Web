...
return array(
	...
	'a_followed_body' => "Your review on ^site_title has a new related song by ^q_handle:\n\n^open^q_title^close\n\nYour review was:\n\n^open^a_content^close\n\nClick below to review the new song:\n\n^url\n\nThank you,\n\n^site_title",
	'a_followed_subject' => 'Your ^site_title review has a related song',
	...
	'q_reviewed_body' => "Your song on ^site_title has been reviewed by ^a_handle:\n\n^open^a_content^close\n\nYour song was:\n\n^open^q_title^close\n\nIf you like this review, you may select it as the best:\n\n^url\n\nThank you,\n\n^site_title",
	'q_reviewed_subject' => 'Your ^site_title song was reviewed',

	'q_commented_body' => "Your song on ^site_title has a new comment by ^c_handle:\n\n^open^c_content^close\n\nYour song was:\n\n^open^c_context^close\n\nYou may respond by adding your own comment:\n\n^url\n\nThank you,\n\n^site_title",
	'q_commented_subject' => 'Your ^site_title song has a new comment',

	'q_posted_body' => "A new song has been posted by ^q_handle:\n\n^open^q_title\n\n^q_content^close\n\nClick below to see the song:\n\n^url\n\nThank you,\n\n^site_title",
	'q_posted_subject' => '^site_title has a new song',
	...
	'welcome_body' => "Thank you for signuping for ^site_title.\n\n^custom^confirmYour signin details are as follows:\n\nUsername: ^handle\nEmail: ^email\n\nPlease keep this information safe for future reference.\n\nThank you,\n\n^site_title\n^url",
