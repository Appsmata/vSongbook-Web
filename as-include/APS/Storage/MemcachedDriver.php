...
/*
	...
	File: as-include/APS/Storage/MemcachedDriver.php
 ...
 */
class APS_Storage_MemcachedDriver implements APS_Storage_CacheDriver
{
	private $memcached;
	...
	public function __construct($config)
	{
		...
		if (extension_loaded('memcached')) {
			...
			$this->error = as_lang_html('admin/no_memcached');
		}
	}
	 ...
	 * @param string $key The unique cache identifier.
	 * @param mixed $data The data to cache (in core APS this is usually an array).
	...
	{
		$this->error = as_lang_html_sub('admin/memcached_error', $this->memcached->getResultMessage());
	}
}
