...
/*
	...
	File: as-include/APS/Storage/FileCacheDriver.php
 ...
 */
class APS_Storage_FileCacheDriver implements APS_Storage_CacheDriver
{
	...
	public function __construct($config)
	{
		...
		if (isset($config['dir'])) {
			...
			if (!is_writable($this->cacheDir)) {
				$this->error = as_lang_html_sub('admin/caching_dir_error', $config['dir']);
			}
		} else {
			$this->error = as_lang_html('admin/caching_dir_missing');
		}
