...
class as_html_theme extends as_html_theme_base
{
	...
	public function html()
	{
		...
		<head>
			...
			<link rel="stylesheet" href="http://localhost/vsongweb/as-theme/vSongBook/css/bootstrap.min.css" >
			<link rel="stylesheet" href="http://localhost/vsongweb/as-theme/vSongBook/css/font-awesome-all.css" >
			<link rel="stylesheet" href="http://localhost/vsongweb/as-theme/vSongBook/as-styles.css">
		</head>
		...
		<body>
			...
			<script src="http://localhost/vsongweb/as-theme/vSongBook/js/popper.min.js" integrity="sha384-cs/chFZiN24E4KMATLdqdvsezGxaGsi4hLGOzlXwp5UZB1LY//20VyM2taTB4QvJ"
				crossorigin="anonymous"></script>
			<script src="http://localhost/vsongweb/as-theme/vSongBook/js/bootstrap.min.js" integrity="sha384-uefMccjFJAIv6A+rW+L4AHf99KvxDjWSu1z9VI8SKNVmz4sk7buKt/6v9KI65qnm"
				crossorigin="anonymous"></script>
			<script src="http://localhost/vsongweb/as-theme/vSongBook/js/datastore.js"></script>
			<script src="http://localhost/vsongweb/as-theme/vSongBook/js/date-utils.js"></script>
			<script src="http://localhost/vsongweb/as-theme/vSongBook/js/script.js"></script>
		</body>
