...
$(document).ready(function () {
	 ...
	 */
	$('.as-part-form-message .as-form-tall-ok').wrapInner('<div class="qam-pm-message"></div>');

	// fix the visible issue for main nav, top search-box
	$(window).resize(function () {
		if (window.matchMedia('(min-width: 980px)').matches) {
			$(".qam-search.the-top .as-search").hide();
			$(".as-nav-main").show('fast', function() { $(this).css('display','inline-block'); });
		} else {
			$(".qam-search.the-top .as-search").show();
			$(".as-nav-main").hide();
